...
public class C03_SoftAssert extends TestBaseBeforeMethodAfterMethod {
    ...
    public void test01() {
/*
softAssert baslangıc ve bıtıs satırları arasındakı tum assertıonları
 yapıp bitis olarak belırtmemız gereken assertAll ()
metoduyla test metodumuzdakı butun assertıonları kontrol eder.
Failed olan olursa assertion yaptıgımız metodun sonuna yazdıgımız mesajı bize konsolda verir
